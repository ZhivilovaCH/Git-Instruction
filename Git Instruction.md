...
*Когда код придет в нужное вам состояние и вы захотите добавить его к себе, его можно будет скачать и выполнить локальное слияние или воспользоваться уже знакомым синтаксисом git pull <url> <ветка>. Можно даже добавить ветвление как удаленный репозиторий и применить команды fetch и merge.*
